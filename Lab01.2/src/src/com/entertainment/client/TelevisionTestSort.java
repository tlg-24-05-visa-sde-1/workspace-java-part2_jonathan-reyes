...
import com.entertainment.TelevisionBrandAndChannelComparator;
...
public class TelevisionTestSort {
    ...
    public static void main(String[] args) {
        ...
        tvList.sort(new TelevisionBrandAndChannelComparator());

        System.out.println("Sorted by brand and then channel");
        for (Television tv : tvList) {
            System.out.println(tv);
        }
        System.out.println();
